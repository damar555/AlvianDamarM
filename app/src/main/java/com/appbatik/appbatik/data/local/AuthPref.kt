package com.appbatik.appbatik.data.local

import android.content.Context
import android.content.SharedPreferences
import com.appbatik.appbatik.data.model.ActionState
import com.appbatik.appbatik.data.model.AuthUser
import com.appbatik.appbatik.util.getObject
import com.appbatik.appbatik.util.putObject
...
class AuthPref(val context: Context) {
    ...
    suspend fun login(email: String, password: String): ActionState<AuthUser>{
        val user = authUser
        return if (user == null){
            ActionState(message = "Anda belu terdaftar", isSuccess = false)
